...
Utilizar funciones puede ser muy util para la lectura y comprensión del código. Una función es un “segmento” o “fracción” de programa que realiza determinadas tareas bien definidas. Esos “fragmentos” de programa son lo que se suele llamar “subrutinas”, “procedimientos” o “funciones”.

La sintaxis para definir una función es la siguiente:
```
tipoRetorno(parámetros){
